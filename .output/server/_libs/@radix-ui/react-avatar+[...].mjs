...
function createContext2(rootComponentName, defaultContext) {
	...
	const Provider = /* @__PURE__ */ __name$5((props) => {
	...
	__name$5(useContext2, "useContext");
	return [Provider, useContext2];
}
__name$5(createContext2, "createContext");
// @__NO_SIDE_EFFECTS__
function createContextScope(scopeName, createContextScopeDeps = []) {
	...
	__name$5(createContext3, "createContext");
	const createScope = /* @__PURE__ */ __name$5(() => {
		const scopeContexts = defaultContexts.map((defaultContext) => {
			return import_react.createContext(defaultContext);
		});
		return /* @__PURE__ */ __name$5(function useScope(scope) {
...
__name$5(createContextScope, "createContextScope");
function composeContextScopes(...scopes) {
	...
	const createScope = /* @__PURE__ */ __name$5(() => {
		...
		return /* @__PURE__ */ __name$5(function useComposedScopes(overrideScopes) {
...
__name$5(composeContextScopes, "composeContextScopes");
//#endregion
...
__name$4(useCallbackRef, "useCallbackRef");
//#endregion
...
//#endregion
export { dispatchDiscreteCustomEvent as a, useLayoutEffect2 as c, require_jsx_runtime as d, Primitive as i, useCallbackRef as l, AvatarFallback as n, createSlot as o, AvatarImage as r, useComposedRefs as s, Avatar as t, createContextScope as u };
