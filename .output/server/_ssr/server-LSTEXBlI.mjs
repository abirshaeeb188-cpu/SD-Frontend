...
import { A as rootRouteId, C as getScriptPreloadAttrs, D as executeRewriteInput, E as resolveManifestCssLink, N as invariant, O as isRedirect, T as resolveManifestAssetLink, a as replaceSsrResponse, i as normalizeSsrResponse, j as isNotFound, k as isResolvedRedirect, l as RouterProvider, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, w as getStylesheetHref } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-LSTEXBlI.js
var server_LSTEXBlI_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DmGejOy-.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CyTaXnVW.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_LSTEXBlI_exports as t };
